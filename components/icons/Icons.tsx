...
export const HomeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0l8.954 8.955M6.75 21V11.25a2.25 2.25 0 012.25-2.25h6a2.25 2.25 0 012.25 2.25V21" />
    </svg>
);
...
export const LogoutIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m0 0l3.75-3.75M15.75 15H3" />
  </svg>
);
...
export const BusIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h18M6.75 16.5a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM18.75 16.5a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
    </svg>
);
...
export const BriefcaseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.8a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25v-4.8m16.5-4.5v-4.8a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 4.85v4.8M21 14.15v-4.5A2.25 2.25 0 0018.75 7.5h-13.5A2.25 2.25 0 003 9.65v4.5" />
...
export const Cog6ToothIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.242 1.417l-1.07 1.07a.938.938 0 000 1.328l1.07 1.07-.006.006a1.125 1.125 0 01-1.417.241l-1.296-2.247a1.125 1.125 0 01-.49-1.37l.456-1.217a.998.998 0 00-1.075-.124.938.938 0 00-.22-.127c-.332-.183-.582-.495-.645-.87l-.213-1.281z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75l-.491-1.362a.938.938 0 010-1.328l.49-1.362a1.125 1.125 0 00-1.37-.49l-1.217.456a.998.998 0 01-1.075-.124.938.938 0 01-.22-.127c-.332-.183-.582-.495-.645-.87l-.213-1.281a1.125 1.125 0 00-1.11-.94h-2.593c-.55 0-1.02.398-1.11.94l-.213 1.281c-.063.374-.313.686-.645.87a.937.937 0 01-.22.127.998.998 0 01-1.075.124l-1.217-.456a1.125 1.125 0 00-1.37.49l-1.296 2.247a1.125 1.125 0 00.242 1.417l1.07 1.07a.938.938 0 010 1.328l-1.07 1.07a1.125 1.125 0 001.417.241l1.296-2.247a1.125 1.125 0 00.49-1.37l-.456-1.217a.998.998 0 011.075-.124c.073.04.146.082.22.127.332.183.582.495.645.87l.213 1.281c.09.542.56.94 1.11.94h2.593c.55 0 1.02.398 1.11.94l.213-1.281c.063-.374.313-.686.645-.87a.937.937 0 00.22-.127.998.998 0 001.075.124l1.217.456a1.125 1.125 0 011.37-.49l1.296-2.247a1.125 1.125 0 01-.242-1.417l-1.07-1.07a.938.938 0 000-1.328l1.07-1.07z" />
...
export const MegaphoneIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15h8.05a1.5 1.5 0 001.442-1.158l.6-3.616a1.5 1.5 0 00-1.442-1.842H1.5M10.5 6L13.5 9M10.5 6L7.5 9" />
    </svg>
);