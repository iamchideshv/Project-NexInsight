  ...
  return (
    <div>
      ...
      <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
        ...
        <div>
          <h3 className="text-xl font-bold text-gray-800 dark:text-white">R. Kumar</h3>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 dark:bg-gray-700/50 p-6 rounded-xl">
          <h4 className="font-bold text-lg mb-4 text-gray-800 dark:text-white">Academic Details</h4>
          <div className="space-y-3 text-gray-700 dark:text-gray-300">
            <p><strong>Roll Number:</strong> 22AIDS050</p>
            <p><strong>Department:</strong> AI & DS</p>
            <p><strong>Year:</strong> III</p>
